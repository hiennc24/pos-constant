...
export const BUSINESS_SERVICES: ServiceConstants = {
  // Tenant Management Services
  SVC_BUSINESS_TENANT_MANAGEMENTS: {
    NAME: "svc-business.tenant-managements",
    //actions
  ...
  SVC_BUSINESS_TENANT_ACCOUNTS: {
    NAME: "svc-business.tenant-accounts",
    ...SERVICE_CRUD_ACTION_COMMONS,
    //actions custom
