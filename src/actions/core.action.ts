...
export const CORE_SERVICES: ServiceConstants = {
  // Tenant Management Services
  SVC_CORE_TENANT_MANAGEMENTS: {
    NAME: "svc-core.tenant-managements",
    //actions
  ...
  SVC_CORE_TENANT_ACCOUNTS: {
    NAME: "svc-core.tenant-accounts",
    ...SERVICE_CRUD_ACTION_COMMONS,
    //actions custom
